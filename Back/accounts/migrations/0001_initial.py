# Generated by Django 4.2.16 on 2024-11-20 14:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career', models.CharField(choices=[('학생', 'student'), ('회사원', 'office_worker'), ('공무원', 'public_servant'), ('전문직', 'professional'), ('자영업자', 'self_employed'), ('프리랜서', 'freelancer'), ('사업자', 'business_owner'), ('아르바이트/비정규직', 'part_time'), ('전업주부', 'housewife'), ('무직/구직중', 'unemployed'), ('은퇴자', 'retired'), ('농업/어업/임업', 'farmer'), ('군인', 'soldier'), ('교사/교육자', 'teacher'), ('의료종사자', 'medical'), ('금융업 종사자', 'financial'), ('IT업계 종사자', 'it_worker'), ('서비스업 종사자', 'service_industry'), ('제조업 종사자', 'manufacturing'), ('스타트업 창업자', 'startup_founder'), ('사회복지사', 'social_worker'), ('연구원', 'researcher'), ('기타', 'other')], max_length=20)),
